...
def twisted_ate_cp8(P, Q, Q_prec, c_vec, F, length_miller, U, K, case: str = 'case1', NAF_rep=False):
    ...
    write_number_operations(file_name, 'final_exp twisted_ate_cp8', case, NAF_rep=NAF_rep,
                            exp_u=exp_u, exp_u0=exp_u0, exp_lx=exp_lx, mult_FE=mult, sq_FE=sq, inv_FE=inv,
                            frobenius=frob)

    return pairing_value


def ate_i(Q, P, P_prec, c_vec, F, length_miller, U, W, case: str = 'case1', NAF_rep=False, family='k16'):
    """
    :param Q:
    :param P:
    :param P_prec:
    ...
    if family == 'k16':
        ...
        pairing_value, exp_u, exp_um, mult, sq, inv, frob_power = final_exponentiation_new_k16(miller_fun, U, W)
