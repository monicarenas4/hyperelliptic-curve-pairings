...
def test_bilinearity_Twisted_Ate(curves, jacobians, fields, c_vec, F, U, p, r, h, h_, length_miller):
    ...
    for case in cases:
        ...
        pairing_value2 = Twisted_Ate_cp8(P2, Q2, Q2_prec, c_vec, F, length_miller, U, Fp, case)**(randint_P*randint_Q)
        ...
        pairing_value_naf2 = Twisted_Ate_naf_cp8(P2, Q2, Q2_prec, c_vec, F, length_miller, U, Fp, case)**(randint_P*randint_Q)
...
def test_bilinearity_Ate_i(curves, jacobians, fields, c_vec, F, U, p, r, h, h_, length_miller):
    ...
    for case in cases:
        ...
        print('pairing value NAF 1 = ', pairing_value_naf1)
        pairing_value_naf2 = Ate_i_naf(Q2, P2, P2_prec, c_vec, F, length_miller, U, pow, case)**(randint_Q*randint_P)
        print('pairing value NAF 2 = ', pairing_value_naf2)
        print('bilinearity NAF test: ', pairing_value_naf1 == pairing_value_naf2)
