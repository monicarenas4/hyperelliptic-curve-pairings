...
from miller_loop import miller_loop_tate_pairing, miller_loop_opt_tate_pairing
from final_exponentiation import final_exp_BLS12, final_exp_easy_BLS12, final_exp_hard_BLS12, \
    final_exp_BLS12_optimized
...
def optimized_tate_pairing(u, check=False):
    ...
    # Bilinearity check
    tate_pairing_bilinearity_check(P, Q, pairing_value, p, r, 'optimized', seed=u) if check == True else None
